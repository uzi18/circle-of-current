...
#define SELECT()	PORTB &= ~0b00001000		/* MMC CS = L */
#define	DESELECT()	PORTB |= 0b00001000		/* MMC CS = H */
...
void power_on (void)
{
	// edited // PORTE &= ~0x80;				/* Socket power ON */
	
	for (Timer1 = 3; Timer1; );	/* Wait for 30ms */
	// _delay_ms(30); // possible replacement

	/* Frank: This is where you need to initilize your SPI port */
	PORTB = 0b01011000; // edited by Frank
...
/* Frank: this function is never needed */
static
void power_off (void)
{
	...
	// edited // PORTE |=  0x80;			/* Socket power OFF */
