...
/-----------------------------------------------------------------------------/
/
/ Frank: I edited some function names
/
...
/                   without write.
/
/ Apr 01,'08 R0.06  Added f_forward(), f_putc(), f_puts(), fprintf() and fgets().
...
#define _FS_TRUNCATE_already_included
...
)
{
	...
	for (n = 0; *str; str++, n++) {
		if (f_putc(*str, fil) == f_EOF) return f_EOF;
	}
	return n;
}
...
#ifdef _FS_TRUNCATE
#ifndef _FS_TRUNCATE_already_included
/*-----------------------------------------------------------------------*/
/* Truncate File                                                         */
/*-----------------------------------------------------------------------*/
...
#endif // _FS_TRUNCATE_already_included
#endif // _FS_TRUNCATE
