...
#define yaw_scale_default 0
#define roll_pitch_scale_default 0

#define fb_accel_center_offset_default 0
#define lr_accel_center_offset_default 0
#define ud_accel_center_offset_default 0

#define fb_lr_accel_scale_default 0
#define ud_accel_scale_default 0

#define ppm_chan_offset_default 0

#define yaw_pid_kp_default 0
#define yaw_pid_ki_default 0
#define yaw_pid_kd_default 0
#define yaw_pid_err_low_thresh_default 0
#define yaw_pid_delta_err_low_thresh_default 0

#define roll_pitch_a_pid_kp_default 0
#define roll_pitch_a_pid_ki_default 0
#define roll_pitch_a_pid_kd_default 0
#define roll_pitch_a_pid_err_low_thresh_default 0
#define roll_pitch_a_pid_delta_err_low_thresh_default 0

#define roll_pitch_b_pid_kp_default 0
#define roll_pitch_b_pid_ki_default 0
#define roll_pitch_b_pid_kd_default 0
#define roll_pitch_b_pid_err_low_thresh_default 0
#define roll_pitch_b_pid_delta_err_low_thresh_default 0

#define servo_pulse_scale_default 0
#define servo_pulse_stop_default 0
#define servo_period_delay_default 0

#define throttle_scale_default 0
#define spin_scale_default 0
#define move_scale_default 0
